...
class CFWBoostingRecommender(RecommenderSystem, RecommenderSystem_SM):

    RECOMMENDER_NAME = "CFWBoostingRecommender"
    ...
    def __repr__(self):
        representation = "CFW Boosting Recommender"
    ...
    def saveModel(self, folder_path, file_name = None):
        ...
        dictionary_to_save = {
            "D_best":self.D_best,
            "topK":self.topK,
            "add_zeros_quota" : self.add_zeros_quota,
