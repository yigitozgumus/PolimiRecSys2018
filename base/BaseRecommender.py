...
class RecommenderSystem(object):
    ...
    RECOMMENDER_NAME = "Abstract_Recommender_Class"
    def __init__(self):
    ...
    def recommend(self, playlist_id_array, cutoff=None, remove_seen_flag=True, remove_top_pop_flag=False,
        ...
        scores_batch = self.compute_item_score(playlist_id_array)
    ...
    def loadModel(self, folder_path, file_name=None,verbose=True):
