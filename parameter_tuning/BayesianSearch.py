...
try:
    ...
    from parameter_tuning.BayesianOptimization.bayes_opt.bayesian_optimization import BayesianOptimization
...
class BayesianSearch(AbstractClassSearch):
    ...
    def search(self, dictionary, metric="MAP", init_points=5, n_cases=30, output_root_path=None, parallelPoolSize=2,
               parallelize=True,
               save_model="best"):
